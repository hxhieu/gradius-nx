...
void
Player::init(const flat2d::GameData* gameData)
{
	...
	addAnimation(
	  "rollUp", new flat2d::Animation(TextureAtlas::PLAYER_ROLL_UP, 200, true));
	addAnimation(
	  "rollDown",
...
void
Player::handle(const SDL_Event& event)
{
	...
	switch (event.type) {
		case SDL_JOYAXISMOTION: {
			...
			//     attached joycons if (event.jbutton.which != 0)
			//         return;
